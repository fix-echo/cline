...
**Section sources**
- [ChatContent.ts](file://src/shared/ChatContent.ts#L1-L6)
...
**Section sources**
- [UserInfo.ts](file://src/shared/UserInfo.ts#L1-L6)

### TelemetrySetting（遥测配置）
`TelemetrySetting` 类型定义了用户对遥测数据收集的偏好设置。
...
**Section sources**
- [TelemetrySetting.ts](file://src/shared/TelemetrySetting.ts#L1-L2)
